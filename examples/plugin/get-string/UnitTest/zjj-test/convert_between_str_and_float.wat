...
(module
  ...
  (import "wasi_snapshot_preview1" "string_to_float" (func $string_to_float(param i32 i32 i32) (result i32)))
  (import "wasi_snapshot_preview1" "string_from_float" (func $string_from_float(param f32 i32 i32) (result i32)))
...
;;     20 -> pointer to written
    (call $get_string (i32.const 24) (i32.const 64) (i32.const 1) (i32.const 20))
    ;; set ciovec buf
;;    (i32.load (i32.const 20)(i))
    (drop(call $string_to_float (i32.const 24) (i32.const 64) (i32.const 16)))
    (drop(call $string_from_float (f32.load (i32.const 16) ) (i32.const 0) (i32.const 8)))
