...
(module
  ...
  (func (export "_start")
    ...
    (drop(call $string_slices (i32.const 24) (i32.load(i32.const 20)) (i32.const 5) (i32.const 2) (i32.const 48)))
    ...
    (drop (call $string_find_substring (i32.const 24) (i32.load(i32.const 20)) (i32.const 48) (i32.const 5) (i32.const 16)))
    ...
    (drop (call $string_rfind_substring (i32.const 24) (i32.load(i32.const 20)) (i32.const 48) (i32.const 2) (i32.const 16)))
    (drop (call $string_from_int (i32.load(i32.const 16)) (i32.const 64) (i32.const 12)))
    (i32.store (i32.const 0) (i32.const 64))
    (i32.store (i32.const 4) (i32.load (i32.const 12)))
    (drop (call $fd_write (i32.const 1) (i32.const 0) (i32.const 1) (i32.const 8)))
